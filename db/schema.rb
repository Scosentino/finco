...
ActiveRecord::Schema.define(version: 20180626161908) do
  ...
  create_table "stocks", force: :cascade do |t|
    ...
    t.string "short_interest"
    t.string "short_date"
    t.string "dividend_rate"
    t.string "dividend_yield"
    t.string "expected_dividend_date"
    t.string "latest_eps"
    t.string "latest_eps_date"
    t.string "float"
    t.string "return_on_equity"
    t.string "consensus_eps"
    t.string "number_of_estimates"
    t.string "eps_surprise_dollar"
    t.string "eps_surprise_percent"
    t.string "return_on_assets"
    t.string "return_on_capital"
    t.string "institution_percent"
    t.string "insider_percent"
    t.string "short_ratio"
    t.string "five_year_percent_change"
    t.string "two_year_percent_change"
    t.string "one_year_percent_change"
    t.string "six_month_percent_change"
    t.string "three_month_percent_change"
    t.string "one_month_percent_change"
    t.string "five_day_percent_change"
  end
